...
public class first_time_recurring_clinics extends AppCompatActivity {
    public void onSkipRecurringButtonClick1(View view)
    {
        // Once they finish inputting diet, send them home
        Intent intent = new Intent(first_time_recurring_clinics.this, home_page.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.first_time_recurring_clinics);
            ...
            if (task.isSuccessful()) {
                ...
                myAdapter.setOnItemClickListener(new MyClinicAdapter.OnItemClickListener() {
                    ...
                    public void onItemClick(int position, Clinic clinic) {
                        ...
                        Intent intent = new Intent(first_time_recurring_clinics.this, first_time_recurring_appointments.class);
