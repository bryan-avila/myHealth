...
public class clinic_sign_up_page extends AppCompatActivity {
    ...
    public void onCareCenterAwaitConfirmation(View view)
    {
        ...
        if(check_clinic_sign_up_info) {
            ...
            Toast.makeText(clinic_sign_up_page.this, "APPROVED.", Toast.LENGTH_LONG).show();
            ...
            mAuth.createUserWithEmailAndPassword(string_c_email, string_c_password)
                    .addOnCompleteListener(clinic_sign_up_page.this, new OnCompleteListener<AuthResult>() {
                        @Override
            ...
            Toast.makeText(clinic_sign_up_page.this, "DISAPPROVED.", Toast.LENGTH_LONG).show();
        }
    }
